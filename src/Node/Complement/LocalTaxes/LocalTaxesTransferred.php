...
/**
 * @method static LocalTaxesTransferred createFromDOMNode(DOMNode $node)
 */
class LocalTaxesTransferred extends CFDINode
{
    #########################
    ##        PRESETS      ##
    #########################
    ...
    protected static $attributes = [
        ...
        'tax'           => [
            'keywords' => ['ImpLocTrasladado', 'tax'],
            'type'  => CFDI::ATTR_REQUIRED
        ],
        'rate'          => [
            'keywords' => ['TasadeTraslado', 'rate'],
            'type' => CFDI::ATTR_REQUIRED
        ],
        'amount'        => [
